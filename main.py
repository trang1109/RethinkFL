...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='fedavg',  # fpl, fedavg, fedprox , moon
                        help='Model name.', choices=get_all_models())
    parser.add_argument('--structure', type=str, default='homogeneity')
    parser.add_argument('--dataset', type=str, default='fl_officecaltech',   # fl_digits, fl_officecaltech
